...
export const FEATURES: FeatureDef[] = [
  ...
  },
  {
    ...
    name:        'Scan & Inspect',
    description: 'Launch a pre-use check from equipment QR labels',
  ...
  },
  {
    ...
    name:        'Defects',
    description: 'Open findings and return-to-service workflow',
  ...
  },
  {
    ...
    name:        'QR Labels',
    description: 'Printable labels for equipment inspections',
  ...
  },
  {
    ...
    name:        'Configuration',
    description: 'Equipment families, inspection schedules, and STRIKE gates',
