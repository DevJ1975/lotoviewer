...
function drawHeader(
  ...
  page.drawText(`Year ${opts.year}`, {
    x: PAGE_W - MARGIN_X - 80, y: top - 17, size: 11, font: bold, color: WHITE,
  })
...
function drawFooter(page: PDFPage, font: PDFFont, opts: RenderOpts, pageIdx: number, pageCount: number) {
  page.drawText(sanitizeForWinAnsi(`Generated by Soteria FIELD · ${opts.year} · Page ${pageIdx + 1} of ${pageCount}`), {
