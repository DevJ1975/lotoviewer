...
export const ADMIN_SECTIONS: AdminSection[] = [
  ...
  },
  {
    ...
    tiles: [
      ...
      tile('loto', 'review-queue',         null,
        ClipboardCheck, 'Equipment review queue',
        'Equipment a supervisor flagged for closer admin review via the public floor-walk link.'),
  ...
  },
  {
    ...
    tiles: [
      ...
      tile('working-at-heights', 'permits',          null,
        ScrollText, 'Permits',
        'Working-at-Heights Permits — pre-condition checklist + clearance calc snapshot + named CP before any at-height task.'),
