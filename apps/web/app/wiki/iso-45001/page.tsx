...
// ISO 45001 implementation guide. The content lives in ./_content.ts;
...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-05-24',
    changes: [
      'Initial ISO 45001:2018 implementation guide. An original, plain-language manual covering the Plan-Do-Check-Act structure and every auditable clause (4 Context, 5 Leadership & worker participation, 6 Planning, 7 Support, 8 Operation, 9 Performance evaluation, 10 Improvement), the documented-information checklist, the certification/audit journey, the glossary, and a map of which Soteria modules produce evidence for which clause. Written in our own words; it points back to the licensed standard for the authoritative requirement text rather than copying it.',
    ],
  },
]

export default function WikiIso45001Page() {
  return (
    <WikiPage
      title={MANUAL_TITLE}
