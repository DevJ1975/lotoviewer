...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date:    '2026-05-15',
    changes: [
      'Added the retraining-attention panel: open §147(g)(2) retraining ' +
      'triggers (deviation observed, procedure change, new hazard) ' +
      'surface here for resolution. See /wiki/loto-compliance.',
    ],
  },
