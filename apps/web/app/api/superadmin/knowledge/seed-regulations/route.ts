...
const MANIFEST: SeedEntry[] = [
  ...
  {
    // Generated by scripts/ingest-osha-1910.mjs from the eCFR API.
    // The seed file is gitignored — operator runs the script locally
    // (it can't run on Vercel due to function-timeout constraints) and
    // then POSTs this endpoint to ingest. If the file is missing, this
    // entry is silently skipped (the route catches ENOENT below).
    key:            'osha-29-cfr-1910-master',
    file:           'federal-osha-29-cfr-1910-master.md',
  ...
  },
  {
    ...
    // Like the federal master above, the seed file is gitignored —
    // operator runs the script locally and then POSTs this endpoint to
    // ingest. If the file is missing, this entry is silently skipped
    // (the route catches ENOENT below).
