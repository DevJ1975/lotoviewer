...
//
// Other ship-with-the-product regulation markdown still flows through here —
// notably Cal/OSHA Title 8, which isn't on the federal eCFR. Add an entry + drop
// the file in apps/web/seed/.
const MANIFEST: SeedEntry[] = [
  {
    // Generated by scripts/ingest-cal-osha-t8.mjs from the DIR site.
    // Cal/OSHA Title 8 is not on the federal eCFR, so this is fetched
    // from dir.ca.gov per-section HTML rather than the eCFR XML API.
    // The seed file is gitignored — operator runs the script locally
    // and then POSTs this endpoint to ingest. If the file is missing,
    // this entry is silently skipped (the route catches ENOENT below).
    key:            'cal-osha-title-8-3314-loto-master',
    file:           'cal-osha-title-8-loto-master.md',
    title:          '8 CCR §3314 — The Control of Hazardous Energy (Lockout/Blockout/Tagout)',
    jurisdiction:   'CA',
    source_url:     'https://www.dir.ca.gov/title8/3314.html',
    source_type:    'state_reg',
    effective_date: null,
  },
]
