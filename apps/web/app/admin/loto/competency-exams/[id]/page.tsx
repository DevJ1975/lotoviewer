...
function Editor() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-5">
      <div>
        <Link href="/admin/loto/competency-exams" className="inline-flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300">
          ...
          <ul className="divide-y divide-slate-100 dark:divide-slate-800">
            {workers.map(w => (
              <li key={w.id} className="py-2 flex items-center gap-3">
                ...
                <Link
                  href={`/admin/loto/competency-exams/${examId}/take/${w.id}`}
