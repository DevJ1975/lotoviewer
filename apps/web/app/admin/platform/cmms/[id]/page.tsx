...
// /admin/platform/cmms/[id] — integration detail.
...
export default function CmmsIntegrationDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!row) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-6">
        <Link href="/admin/platform/cmms" className="inline-flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 space-y-5">
      <div>
        <Link href="/admin/platform/cmms" className="inline-flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300">
          <ArrowLeft className="h-3 w-3" /> Back to CMMS list
        </Link>
