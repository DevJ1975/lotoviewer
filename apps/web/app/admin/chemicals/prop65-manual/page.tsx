...
// /admin/chemicals/prop65-manual — user manual for the California Prop 65 module.
//
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-8 space-y-8 text-slate-800 dark:text-slate-100">
      ...
      <Section id="sites" title="California sites + public route">
        <p>
          <strong>Where to find it.</strong>{' '}
          <Link href="/admin/chemicals/prop65/sites">/admin/chemicals/prop65/sites</Link>.
        </p>
        <p>
      ...
      <Section id="assessments" title="Exposure assessments + safe harbor">
        <p>
          ...
          <Link href="/admin/chemicals/prop65/assessments/new">/admin/chemicals/prop65/assessments/new</Link>.
        </p>
        <p>
      ...
      <Section id="notifications" title="§5194(h) employee notifications">
        <p>
          ...
          <Link href="/admin/chemicals/prop65/sites">/admin/chemicals/prop65/sites/[id]</Link>
      ...
      <Section id="annual" title="Annual review (§25249.5)">
        <p>
          <strong>Where to find it.</strong>{' '}
          <Link href="/admin/chemicals/prop65/annual-review">/admin/chemicals/prop65/annual-review</Link>.
        </p>
        <p>
      ...
      <Section id="integrations" title="Integrations with other modules">
        <ul>
          ...
          <li><strong>ISO 45001 clause map.</strong> Clauses 6.1.3
            ...
            export at{' '}
            <Link href="/admin/evidence/iso45001/6.1.3">/admin/evidence/iso45001/6.1.3</Link>
