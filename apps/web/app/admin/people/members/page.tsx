                ...
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      <Link href={`/admin/people/members/${m.member_id}`} className="truncate text-sm font-black text-slate-950 hover:text-brand-navy dark:text-slate-50 dark:hover:text-brand-yellow">{m.display_name}</Link>
