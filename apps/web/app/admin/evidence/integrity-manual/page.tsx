...
// /admin/evidence/integrity-manual — user manual for Module 2: Integrity & Compliance.
//
    ...
    <main className="max-w-3xl mx-auto px-4 py-8 space-y-8 text-slate-800 dark:text-slate-100">
      ...
      <Section id="sealed" title="Sealed PDF artifacts (SHA-256 chain-of-custody)">
        ...
        <p>
          ...
          bundle cover sheet (<Link href="/admin/compliance/compliance-bundle">/admin/compliance/compliance-bundle</Link>)
      ...
      <Section id="capas" title="Incident CAPAs with verification of effectiveness">
        ...
        <p>
          ...
          <Link href="/admin/insights/risk-intelligence">/admin/insights/risk-intelligence</Link> shows
      ...
      <Section id="iso45001" title="ISO 45001 clause-evidence map">
        <p>
          <strong>Where to find it.</strong>{' '}
          <Link href="/admin/evidence/iso45001">/admin/evidence/iso45001</Link>.
        </p>
        <p>
