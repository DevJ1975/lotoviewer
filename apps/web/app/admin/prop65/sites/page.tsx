...
// /admin/prop65/sites — list + add CA facilities.
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {rows.map(r => (
                <tr key={r.id} className="hover:bg-slate-50 dark:hover:bg-slate-900/40">
                  <td className="px-4 py-2"><Link href={`/admin/prop65/sites/${r.id}`} className="text-brand-navy hover:underline">{r.name}</Link></td>
