  ...
  return (
    <div className="relative">
      <button
        ...
        className="text-slate-400 dark:text-slate-500 hover:text-brand-navy hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md h-11 w-11 flex items-center justify-center transition-colors disabled:opacity-40"
      >
