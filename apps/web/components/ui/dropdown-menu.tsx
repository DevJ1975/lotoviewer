...
// Phase 1 dropdown-menu primitive built on Base UI Menu. Submenu
// support and group-label sub-components are intentionally omitted
// from this initial pass — the exact Base UI export shape for those
// (Menu.SubmenuRoot vs Menu.Submenu, Menu.GroupLabel etc.) varies
// between minor versions and we want the primitive to land first.
// Add them back once a real call site verifies the API.
