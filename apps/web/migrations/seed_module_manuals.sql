...
values
  ...
  ('compliance',      'Compliance',          'AI-driven compliance calendar + legal registry — track citations and the obligations they generate.', E'## Overview\n\nThis manual covers the Compliance Calendar + Legal Registry. **Edit me.**'),
