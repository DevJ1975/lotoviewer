    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-slate-100">
          <div>
            <h2 className="text-base font-semibold text-slate-900">Rename Department</h2>
            <p className="text-xs text-slate-400 mt-0.5">{currentName}</p>
          </div>
          <button
            onClick={onClose}
            disabled={submitting}
        ...
        <div className="px-6 py-5 space-y-3">
          <label className="text-xs font-semibold text-slate-600 block" htmlFor="rename-dept-input">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-navy/20 focus:border-brand-navy transition-colors disabled:bg-slate-50 disabled:text-slate-500"
          />
          ...
          <p className="text-[11px] text-slate-400">
            ...
            <span className="font-medium text-slate-600">{currentName}</span>{' '}
